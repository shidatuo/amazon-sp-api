...
use Amazon\SpApi\Models\Finances\ListFinancialEventGroupsResponse;
use Amazon\SpApi\Models\Finances\ListFinancialEventsResponse;
...
class FinancesApi
{
     ...
     *
     * @return \Amazon\SpApi\Models\Finances\ListFinancialEventGroupsResponse
     */
     ...
     * @throws \Amazon\SpApi\ApiException on non-2xx response
     *
     * @return array of \Amazon\SpApi\Models\Finances\ListFinancialEventGroupsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Amazon\SpApi\Models\Finances\ListFinancialEventGroupsResponse';
        $request = $this->listFinancialEventGroupsRequest($max_results_per_page, $financial_event_group_started_before, $financial_event_group_started_after, $next_token);
     ...
     * @throws \Amazon\SpApi\ApiException on non-2xx response
     *
     * @return \Amazon\SpApi\Models\Finances\ListFinancialEventsResponse
     */
     ...
     * @throws \Amazon\SpApi\ApiException on non-2xx response
     *
     * @return array of \Amazon\SpApi\Models\Finances\ListFinancialEventsResponse, HTTP status code, HTTP response headers (array of strings)
     */
