...
class ASECryptoStream
{
    ...
    /**
     * @param string $plainText [required] unencrypted text
     * @param string $key [required] Key to encrypt
     * @param string $iv [required] The salt value for the block to encrypt.
     * @return string
     ...
     * @param string $iv The salt value for the block to be decrypted.
     * @return string decrypted string
     * @description Get decrypted string
     */
